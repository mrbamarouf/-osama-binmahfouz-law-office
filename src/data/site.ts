...
export const coreCopy = {
  headline: {
    ...
    en: "With you at every step, until your right is secured"
  } satisfies LocalizedText,
  support: {
  ...
  quote: {
    ...
    en: "Your rights are not subject to compromise, and your trust is not subject to neglect; therefore, we are committed to serving you with strong legal representation, considered solutions, and unwavering defense."
  } satisfies LocalizedText,
  closing: {
    ar: "ثقتك أمانة.. ورضاك هدفنا",
    en: "Your trust is a responsibility, and your satisfaction is our goal"
  } satisfies LocalizedText
};
...
export const services: Service[] = [
  {
    ...
    image: "/images/paper-pen-detail.webp"
  },
  {
    ...
    image: "/images/documents-desk.webp"
  },
  {
    slug: "labor-cases",
    title: {
    ...
    image: "/images/notebook-desk.webp"
  },
  {
    ...
    image: "/images/jeddah-skyline.webp"
  },
  {
    ...
    image: "/images/about-architecture.webp"
  },
  {
